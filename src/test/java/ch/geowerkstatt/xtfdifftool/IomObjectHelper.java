...
public final class IomObjectHelper {
    ...
    /**
     * Create a closed rectangular boundary.
     */
    ...
    /**
     * Create a Polygon object from the boundaries. The first boundary is the exterior boundary while the remaining
     * boundaries form interior holes. Boundaries can be created with {@link IomObjectHelper#createBoundary}.
     */
    ...
    /**
     * Create a BOUNDARY object consisting of one POLYLINE object with the specified segments. Segments can be created with
     * {@link IomObjectHelper#createCoord} or {@link IomObjectHelper#createArc} and always starts with a coord as the starting point.
     */
    ...
    /**
     * Create a POLYLINE object with the specified segments. Segments can be created with {@link IomObjectHelper#createCoord}
     * or {@link IomObjectHelper#createArc} and always starts with a coord as the starting point.
     */
    ...
    public static IomObject createMultiCoord(IomObject... coords) {
        IomObject multiCoord = new Iom_jObject(("MULTICOORD"), null);
        for (IomObject coord : coords) {
    ...
    public static IomObject createRef(String targetOid) {
        var ref = new Iom_jObject(Iom_jObject.REF, null);
        ref.setobjectrefoid(targetOid);
        return ref;
    }

    public static IomObject createObject(String tag, String oid) {
        return createObject(tag, oid, _ -> {
        });
    }

    public static IomObject createObject(String tag, String oid, Consumer<Iom_jObject> configure) {
        var result = new Iom_jObject(tag, oid);
